    ...
    <div className="bg-[#BFC7EE] h-screen w-full flex flex-col items-center">
      ...
      <div className="bg-[#8e9be5] h-[600px] w-[600px] flex flex-col items-center mt-[20px]">
        ...
        onSubmit={handleSubmit}>
          ...
          onChange={e => setAluminiData({...aluminiData, name: e.target.value})}
          />
          <input 
          type="text" 
          placeholder="Email" 
          ...
          className="w-[300px] h-[40px] rounded-[10px] align-middle pl-3"
          onChange={e => setAluminiData({...aluminiData, email: e.target.value})}
          />
          <input 
          type="text" 
          ...
          onChange={e => setAluminiData({...aluminiData, password: e.target.value})}
          />
          <input 
          type="text" 
          ...
          className="h-[40px] w-[300px] rounded-[10px] align-middle pl-3"
          onChange={e => setAluminiData({...aluminiData, domainKnowledge: e.target.value})}
          />
          <input 
          type="text" 
          ...
          className="h-[40px] w-[300px] rounded-[10px] align-middle pl-3"
          onChange={e => setAluminiData({...aluminiData, organisatioName: e.target.value})}
          />
           <input 
          type="text" 
          placeholder="Batch" 
          value={aluminiData.otherDomain}
          className="h-[40px] w-[300px] rounded-[10px] align-middle pl-3"
          onChange={e => setAluminiData({...aluminiData, batch: e.target.value})}
          />
